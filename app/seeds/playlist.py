...
def seed_playlists(posts):
  playlists = [
    Playlist(
      user_id=1, name='Melancholy Music', private=False, created_at=current_date, updated_at=current_date, posts=[posts[3], posts[4], posts[11], posts[14], posts[16]]
    ),
    Playlist(
